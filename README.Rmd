...
And, we can compare to STL + IQR methods, which use different decomposition and anomaly detection approaches.
...
- `plot_anomaly_decomposition()` for visualizing the inner workings of how the "remainder" is analyzed for anomalies. 

## References

We investigated several other packages when developing anomaly detection methods used in `anomalize`:
