...
## Example - Forecasting R Package Downloads

Here is a short example with the `tidyverse_cran_downloads` dataset that comes with `anomalize`.
...
- [Learning Lab 17](https://university.business-science.io/p/learning-labs-pro) - Anomaly Detection with H`2O` Machine Learning
